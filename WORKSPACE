...
# Note: AWS dependencies will be enabled once it is removed from tensorflow,
# for now place it before tensorflow to override.
http_archive(
    name = "aws-checksums",
...
http_archive(
    name = "org_tensorflow",
    sha256 = "a198a493314f71dd7721fc129fc5add5cdefb2a361b302def420f02b7f83ccdc",
    strip_prefix = "tensorflow-2.7.0-rc0",
    urls = [
        "https://github.com/tensorflow/tensorflow/archive/refs/tags/v2.7.0-rc0.tar.gz",
    ],
)
