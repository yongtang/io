...
load("//:tools/build/tensorflow_io.bzl", "llvm_archive", "tensorflow_archive")
...
llvm_archive(
    ...
    urls = [
        "https://storage.googleapis.com/mirror.tensorflow.org/github.com/llvm/llvm-project/archive/{commit}.tar.gz",
        "https://github.com/llvm/llvm-project/archive/{commit}.tar.gz",
    ],
)
