...
http_archive(
    ...
    sha256 = "5848f346759546efc00dc5afafdff00ed1fdfd16a93d857649e6a7f82e2d222d",
    strip_prefix = "librdkafka-1.4.0-PRE6",
    urls = [
        "https://github.com/edenhill/librdkafka/archive/v1.4.0-PRE6.tar.gz",
    ],
)
