...
# Note: org_tensorflow is exclusively needed for llvm-project, not for header inclusions
# Note: org_tensorflow and llvm-project should comes from the same tensorflow commit
http_archive(
    name = "org_tensorflow",
    patch_cmds = [
    ...
    urls = [
        "https://storage.googleapis.com/mirror.tensorflow.org/github.com/tensorflow/tensorflow/archive/e71f97fd6b9ae45d6703f3f762aa6646a2ec7a0a.tar.gz",
        "https://github.com/tensorflow/tensorflow/archive/e71f97fd6b9ae45d6703f3f762aa6646a2ec7a0a.tar.gz",
    ],
)
