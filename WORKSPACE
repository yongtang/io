...
# NOTE: Update of org_tensorflow and llvm-project should be in sync,
# check LLVM_COMMIT/LLVM_SHA256 in tensorflow/workspace.bzl.
http_archive(
    name = "org_tensorflow",
    patch_cmds = [
    ...
    sha256 = "65603bbf7a15617237e99453af2aee10a55d04770f5a716d555e0073a167268d",
    strip_prefix = "tensorflow-2.3.0-rc1",
    urls = [
        "https://storage.googleapis.com/mirror.tensorflow.org/github.com/tensorflow/tensorflow/archive/v2.3.0-rc1.tar.gz",
        "https://github.com/tensorflow/tensorflow/archive/v2.3.0-rc1.tar.gz",
    ],
)
...
tf_http_archive(
    ...
    strip_prefix = "llvm-project-7e825abd5704ce28b166f9463d4bd304348fd2a9",
    urls = [
        "https://storage.googleapis.com/mirror.tensorflow.org/github.com/llvm/llvm-project/archive/7e825abd5704ce28b166f9463d4bd304348fd2a9.tar.gz",
