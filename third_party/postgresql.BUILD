...
# Generated from macOS's configure with the following removed:
# - HAVE_DECL_STRLCPY                   (in defines)
# - HAVE_STRLCPY                        (in defines)
# - HAVE_STRUCT_SOCKADDR_STORAGE_SS_LEN (in defines)
# - HAVE_SYS_UCRED_H                    (in defines)
genrule(
    name = "pg_config_h",
    srcs = select({
        "@bazel_tools//src/conditions:windows": [
